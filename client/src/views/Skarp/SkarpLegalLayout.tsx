...
const SkarpLegalLayout: React.FC<Props> = ({
    pageTitle,
    pageDescription,
    copy,
    sections,
    ...
    return (
        <Box sx={{ backgroundColor: colors.bg, minHeight: '100vh', color: colors.text }}>
            ...
            <Box
                sx={{
                    background: `radial-gradient(1000px 520px at 50% -10%, rgba(92,107,192,0.32), transparent 60%), ${colors.bg}`,
                    pt: { xs: 8, md: 10 },
                    pb: { xs: 5, md: 6 },
                }}
            >
...
export default SkarpLegalLayout
