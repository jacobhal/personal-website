        ...
        const fetchData = async () => {
            ...
            axios.all([
                ...
                gD.map(geo => {
                    ...
                    let currentCountryCoronaData = coronaResult.data[currentCountryGeoData.NAME];
                    if (currentCountryCoronaData === undefined) {
                        currentCountryCoronaData = coronaResult.data[CountryMapper[currentCountryGeoData.NAME]];
                    }
